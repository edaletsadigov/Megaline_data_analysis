...
For the interactive (hover/zoom/pan) versions of these same charts, plus the full interactive dashboard, open [`../notebooks/Statistics_project_2.ipynb`](../notebooks/Statistics_project_2.ipynb).
